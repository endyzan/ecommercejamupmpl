<div class="">
    @if ($errors->has('update'))
        <div class="flex items-center p-4 mb-0 pt-18 w-screen text-sm text-yellow-800 bg-yellow-50" role="alert">
            ...
            <div>
                <span class="font-medium">Warning!</span> {{ $errors->first('update') }}
    ...
    @if ($errors->has('login'))
        <div class="flex items-center p-4 mb-0 pt-18 w-screen text-sm text-yellow-800 bg-yellow-50" role="alert">
            ...
            <span class="sr-only">Info</span>
            <div>
                <span class="font-medium">Warning!</span> {{ $errors->first('login') }}
                <br> {{ $errors->first('details') }}
            </div>
        </div>
    @endif
    ...
    @if ($errors->has('register'))
        <div class="flex items-center p-4 mb-0 pt-18 w-screen text-sm text-yellow-800 bg-yellow-50" role="alert">
            ...
            <span class="sr-only">Info</span>
            <div>
                <span class="font-medium">Warning!</span> {{ $errors->first('register') }}
                <br> {{ $errors->first('details') }}
            </div>
        </div>
    @endif

    @if ($errors->has('forgot_password'))
        <div class="flex items-center p-4 mb-0 pt-18 w-screen text-sm text-yellow-800 bg-yellow-50" role="alert">
            <svg class="shrink-0 inline w-4 h-4 me-3" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                viewBox="0 0 20 20">
                <path
            ...
            <span class="sr-only">Info</span>
            <div>
                <span class="font-medium">Warning!</span> {{ $errors->first('forgot_password') }}
                <br> {{ $errors->first('details') }}
            </div>
        </div>
    @endif
