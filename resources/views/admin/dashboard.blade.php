...
@php
    $products = [
        1 => (object) ['id' => 1, 'name' => 'Product A', 'price' => 1000, 'image' => 'product-a.jpg'],
        2 => (object) ['id' => 2, 'name' => 'Product B', 'price' => 1200, 'image' => 'product-b.jpg'],
        3 => (object) ['id' => 3, 'name' => 'Product C', 'price' => 900, 'image' => 'product-c.jpg'],
        4 => (object) ['id' => 4, 'name' => 'Product D', 'price' => 1100, 'image' => 'product-d.jpg'],
        5 => (object) ['id' => 5, 'name' => 'Product E', 'price' => 950, 'image' => 'product-e.jpg'],
    ];
    ...
    $complete_order = 30;
    $total = 52000;
    $cash_on_payment = 30000;
    $online_payment = 22000;
    $customer = 150;
    $delivery_boy = 12;
    $admin = 3;

    $per_rate = [4.5, 4.3, 4.2, 4.1, 4.0];
    $copy_product = [1 => 4.5, 2 => 4.3, 3 => 4.2, 4 => 4.1, 5 => 4.0];
    $product_cart = [3 => 50, 1 => 40, 2 => 35, 4 => 20, 5 => 10];
    $copy_cart = [3 => 50, 1 => 40, 2 => 35, 4 => 20, 5 => 10];
@endphp
                            ...
                            <div class="preview-list">
                                ...
                                @foreach ($per_rate as $prod)
                                    ...
                                    @php
                                        ...
                                        $product_get = $products[$index_search];
                                        $copy_product[$index_search] = null;
                                        $voter = $rates_count[$index_search] ?? 0;
                                    @endphp
                                    ...
                                    <div class="preview-item border-bottom">
                                        <div class="preview-thumbnail">
                                            <div class="preview-icon bg-primary">
                                                ...
                                                <img class="img-xs"
                                                    src="{{ asset('assets/images/' . $product_get->image) }}"
                                                    alt="">
