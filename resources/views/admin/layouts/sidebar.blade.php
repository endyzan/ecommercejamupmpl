...
<aside id="sidebar"
    ...
    aria-label="Sidebar"> --}}
<aside id="sidebar"
    class="fixed top-0 left-0 z-20 flex-col flex-shrink-0 w-64 h-screen pt-16 font-normal transform -translate-x-full transition-transform duration-300 ease-in-out lg:translate-x-0 lg:flex min-h-screen hidden"
    aria-label="Sidebar">

    <div
        class="relative flex flex-col flex-1 min-h-screen pt-0 bg-white border-r border-gray-200 dark:bg-gray-800 dark:border-gray-700">
            ...
            <div
                ...
                <ul class="pb-2 space-y-2">
                    ...
                    <li>
                        <a href="{{ route('panel.transactions') }}"
                            ...
                            <span class="ml-3" sidebar-toggle-item>Manajemen Transaksi</span>
                        </a>
                    </li>
                    <li>
                        <button type="button"
                        ...
                        <ul id="dropdown-crud" class="space-y-2 py-2">
                            {{-- <ul id="dropdown-crud" class="space-y-2 py-2 @if ($params['group'] !== 'crud') hidden @endif"> --}}
                            <li>
                                <a href="{{ route('panel.produk') }}"
                                    class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700 @if ($page_slug === 'products') bg-gray-100 dark:bg-gray-700 @endif">
                                    Produk
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('panel.kategori') }}"
                    ...
                    {{-- <li>
                        <a href="#"
                            class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700 @if ($page_slug === 'settings') bg-gray-100 dark:bg-gray-700 @endif">
                            <svg class="w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
                                fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"
                                aria-hidden="true">
                                <path clip-rule="evenodd" fill-rule="evenodd"
                ...
                <div class="pt-2 space-y-2">
                    <a href="{{ route('home') }}" target="_blank"
                        ...
                        <span class="ml-3" sidebar-toggle-item>Kembali Ke Website</span>
                    </a>
                </div>
            </div>
        </div>
