        ...
        <div class="menu-item-carousel">
            <div class="col-lg-12">
                <div class="owl-menu-item owl-carousel">
                    ...
                    <div class="item">
                        <div class='card' style="background-image: url({{ asset('assets/images/jamu-madura.jpg') }})">
                            <div class="price">
                                <h6>৳45.000</h6>
                                {{-- Produk tersedia --}}
                            ...
                            <div class='info'>
                                <h1 class='title'>Jamu Madura Asli</h1>
                                <p class='description'>
                                    Jamu Madura tradisional yang dibuat dari bahan-bahan alami pilihan. Membantu menjaga
                                    kesehatan, kebugaran, dan keharmonisan rumah tangga.
                                </p>
                                <div class="main-text-button">
                                    <div class="scroll-to-section">
                                        ...
                                        <br>
                                        <a href="/rate/1" style="color:blue;">Rate this</a>
                                        <p>Quantity:</p>
